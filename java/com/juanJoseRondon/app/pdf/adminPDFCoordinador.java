...
@Component("/admin/adminEstudiante")
public class adminPDFCoordinador extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		PdfPTable tablaEstudiantes = new PdfPTable(8);
		tablaEstudiantes.setWidths(new float[] { 1f, 1f, 1f, 0.7f, 1.7f, 1f, 0.8f, 1f});
		...
		celda = new PdfPCell(new Phrase("Acudiente", fuenteTC));
		celda.setBackgroundColor(Color.lightGray);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setVerticalAlignment(Element.ALIGN_CENTER);
		celda.setPadding(10);
		...
		celda = new PdfPCell(new Phrase("Telefono", fuenteTC));
		celda.setBackgroundColor(Color.lightGray);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setVerticalAlignment(Element.ALIGN_CENTER);
		celda.setPadding(10);
		...
		celda = new PdfPCell(new Phrase("Fecha Nac", fuenteTC));
		celda.setBackgroundColor(Color.lightGray);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setVerticalAlignment(Element.ALIGN_CENTER);
		celda.setPadding(10);
		...
		for (estudiantes estudiantes : listadoEstudiantes) {
			...
			celda = new PdfPCell(new Phrase(estudiantes.getCorreoElectronico(), fuenteTexto));
			celda.setPadding(5);
			tablaEstudiantes.addCell(celda);

			celda = new PdfPCell(new Phrase(estudiantes.getAcudiente().getNombre(), fuenteTexto));
			celda.setPadding(5);
			tablaEstudiantes.addCell(celda);

			celda = new PdfPCell(new Phrase(estudiantes.getTelefono(), fuenteTexto));
			celda.setPadding(5);
			tablaEstudiantes.addCell(celda);

			celda = new PdfPCell(new Phrase(estudiantes.getFechaNacimiento(), fuenteTexto));
			celda.setPadding(5);
			tablaEstudiantes.addCell(celda);
